package com.example.prototype.mymoviecataloguemade3.ui.setting
...
class SettingAdapter(private val listSetting: ArrayList<String>) : RecyclerView.Adapter<SettingAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ListViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.item_row_setting, viewGroup, false)
